...
const zh = {
  ...
  wiz_key_prompt: "输入 {provider} 的 API Key（输入不显示 · 回车确认 · Ctrl+C/Ctrl+Q 取消）: ",
...
const en = {
  ...
  wiz_key_prompt: "Enter the {provider} API key (hidden input · Enter to confirm · Ctrl+C/Ctrl+Q to cancel): ",
